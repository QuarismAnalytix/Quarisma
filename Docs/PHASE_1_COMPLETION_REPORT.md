...
- ✅ Updated `PARALLEL_MAX_BACKENDS_NB` from 4 to 3
...
- ✅ Removed `PARALLEL_ENABLE_SEQUENTIAL` conditional compilation blocks
...
- `Library/Core/parallel/std_thread/parallel_thread_local_backend.h:14` - Comment about sequential lookups (unrelated)
- `Library/Core/parallel/openmp/parallel_thread_local_backend.h:14` - Comment about sequential lookups (unrelated)

### Code Reduction

| Metric | Before | After | Reduction |
|--------|--------|-------|-----------|
| parallel_tools_api.h | 311 lines | 189 lines | 39% |
| parallel_tools_api.cpp | 285 lines | 264 lines | 7% |
