...
| `external` | `QUARISMA_ENABLE_EXTERNAL` | Use external system libraries | OFF |
...
| Flag | CMake Variable | Description | Default |
|------|----------------|-------------|---------|
| `ccache` | `QUARISMA_CACHE_TYPE` | Use ccache compiler cache | - |
| `sccache` | `QUARISMA_CACHE_TYPE` | Use sccache distributed cache | - |
| `buildcache` | `QUARISMA_CACHE_TYPE` | Use buildcache | - |
| `none` | `QUARISMA_CACHE_TYPE` | Disable caching | - |
