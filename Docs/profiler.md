...
Quarisma provides a PyTorch-compatible profiler API for seamless integration:
...
Quarisma integrates with PyTorch's Kineto profiler for comprehensive CPU and GPU profiling.
