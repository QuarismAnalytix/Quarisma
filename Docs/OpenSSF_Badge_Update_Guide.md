...
**Justification text:**
```
Quarisma does not use broken cryptographic algorithms. SHA-256 is used for hashing (not MD4, MD5, SHA-1, or single DES). Platform-specific secure random generators are used (not weak PRNGs). See Library/Security/crypto.cxx.
```
