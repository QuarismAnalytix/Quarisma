...
struct C10_API PlacementDeleteContext
{
    ...
    static DataPtr          makeDataPtr(
                 DataPtr&& data_ptr, PlacementDtor placement_dtor, size_t size, Device device);
...
public:
    ...
    bool is_mkldnn() const { return key_set_.has_all(c10::mkldnn_ks); }
...
public:
   ...
   */
    ...
    void generic_set_sizes_contiguous(c10::IntArrayRef sizes) { set_sizes_contiguous(sizes); }
   ...
   */
    ...
    bool is_python_dispatch() const { return key_set_.has_all(c10::python_ks); }
...
public:
   ...
   */
    ...
    const c10::VariableVersion& version_counter() const noexcept { return version_counter_; }
...
private:
    ...
    std::optional<c10::Device> device_opt() const { return device_opt_; }
...
private:
    ...
    bool SetDims(ArrayRef<int64_t> s) { return SetDimsTemplate(s); }

    bool SetDims(ArrayRef<int> s) { return SetDimsTemplate(s); }

    bool SetDims(ArrayRef<size_t> s) { return SetDimsTemplate(s); }
...
static_assert(
    C10_TensorImpl_Size_Check_Dummy_Class<>::check_sizes(), "You should not see this message.");
