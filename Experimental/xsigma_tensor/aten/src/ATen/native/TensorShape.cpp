...
#include <Quarisma/native/TensorShape.h>
#include <Quarisma/native/TypeProperties.h>
#include <Quarisma/native/cpu/CatKernel.h>
#include <Quarisma/native/cpu/SerialStackImpl.h>
#include <Quarisma/native/cpu/StackKernel.h>
...
#else
#include <Quarisma/ops/_chunk_cat_native.h>
#include <Quarisma/ops/_conj_copy_native.h>
#include <Quarisma/ops/_convert_indices_from_coo_to_csr.h>
#include <Quarisma/ops/_convert_indices_from_csr_to_coo.h>
#include <Quarisma/ops/_foreach_copy.h>
#include <Quarisma/ops/_fw_primal_copy_native.h>
#include <Quarisma/ops/_indices_copy_native.h>
#include <Quarisma/ops/_make_dual.h>
#include <Quarisma/ops/_make_dual_copy_native.h>
#include <Quarisma/ops/_mkldnn_reshape.h>
#include <Quarisma/ops/_mkldnn_transpose.h>
#include <Quarisma/ops/_neg_view_copy_native.h>
#include <Quarisma/ops/_reshape_alias_copy_native.h>
#include <Quarisma/ops/_reshape_alias_native.h>
#include <Quarisma/ops/_reshape_copy_native.h>
#include <Quarisma/ops/_reshape_from_tensor_native.h>
#include <Quarisma/ops/_shape_as_tensor_native.h>
#include <Quarisma/ops/_sparse_broadcast_to.h>
#include <Quarisma/ops/_sparse_broadcast_to_copy_native.h>
#include <Quarisma/ops/_sparse_broadcast_to_native.h>
...
#include <Quarisma/ops/_sparse_csr_tensor_unsafe.h>
#include <Quarisma/ops/_sparse_csr_tensor_unsafe_native.h>
#include <Quarisma/ops/_stack_native.h>
#include <Quarisma/ops/_unsafe_view.h>
#include <Quarisma/ops/_unsafe_view_native.h>
#include <Quarisma/ops/_values_copy_native.h>
#include <Quarisma/ops/adjoint_native.h>
#include <Quarisma/ops/alias.h>
#include <Quarisma/ops/alias_copy_native.h>
#include <Quarisma/ops/alias_native.h>
#include <Quarisma/ops/arange.h>
#include <Quarisma/ops/arange_native.h>
#include <Quarisma/ops/as_strided_copy_native.h>
#include <Quarisma/ops/as_strided_native.h>
#include <Quarisma/ops/as_strided_scatter_native.h>
#include <Quarisma/ops/atleast_1d.h>
#include <Quarisma/ops/atleast_2d.h>
#include <Quarisma/ops/atleast_3d.h>
#include <Quarisma/ops/block_diag_native.h>
#include <Quarisma/ops/broadcast_tensors_native.h>
#include <Quarisma/ops/broadcast_to_native.h>
#include <Quarisma/ops/cat.h>
#include <Quarisma/ops/cat_meta.h>
#include <Quarisma/ops/cat_native.h>
#include <Quarisma/ops/chunk_native.h>
#include <Quarisma/ops/col_indices_copy_native.h>
#include <Quarisma/ops/column_stack_native.h>
#include <Quarisma/ops/concat_native.h>
#include <Quarisma/ops/concatenate_native.h>
#include <Quarisma/ops/crow_indices_copy_native.h>
#include <Quarisma/ops/dense_dim_native.h>
#include <Quarisma/ops/detach_copy_native.h>
#include <Quarisma/ops/detach_native.h>
#include <Quarisma/ops/diag.h>
#include <Quarisma/ops/diag_embed.h>
#include <Quarisma/ops/diag_embed_native.h>
#include <Quarisma/ops/diag_native.h>
#include <Quarisma/ops/diagflat_native.h>
#include <Quarisma/ops/diagonal.h>
#include <Quarisma/ops/diagonal_backward.h>
#include <Quarisma/ops/diagonal_backward_native.h>
#include <Quarisma/ops/diagonal_copy.h>
#include <Quarisma/ops/diagonal_copy_native.h>
#include <Quarisma/ops/diagonal_native.h>
#include <Quarisma/ops/diagonal_scatter_native.h>
#include <Quarisma/ops/dsplit_native.h>
#include <Quarisma/ops/dstack_native.h>
#include <Quarisma/ops/empty.h>
#include <Quarisma/ops/empty_like.h>
#include <Quarisma/ops/empty_quantized.h>
#include <Quarisma/ops/expand_as_native.h>
#include <Quarisma/ops/expand_copy_native.h>
#include <Quarisma/ops/expand_native.h>
#include <Quarisma/ops/flatten_dense_tensors_native.h>
#include <Quarisma/ops/flatten_native.h>
#include <Quarisma/ops/from_blob.h>
#include <Quarisma/ops/hsplit_native.h>
#include <Quarisma/ops/hstack.h>
#include <Quarisma/ops/hstack_native.h>
#include <Quarisma/ops/index_select_native.h>
#include <Quarisma/ops/indices_copy_native.h>
#include <Quarisma/ops/lift_fresh_native.h>
#include <Quarisma/ops/lift_native.h>
#include <Quarisma/ops/mH_native.h>
#include <Quarisma/ops/mT_native.h>
#include <Quarisma/ops/matrix_H_native.h>
#include <Quarisma/ops/meshgrid_native.h>
#include <Quarisma/ops/moveaxis_native.h>
#include <Quarisma/ops/movedim.h>
#include <Quarisma/ops/movedim_native.h>
#include <Quarisma/ops/narrow.h>
#include <Quarisma/ops/narrow_copy.h>
#include <Quarisma/ops/narrow_copy_native.h>
#include <Quarisma/ops/narrow_native.h>
#include <Quarisma/ops/new_empty_native.h>
#include <Quarisma/ops/new_ones_native.h>
#include <Quarisma/ops/numpy_T_native.h>
#include <Quarisma/ops/permute_copy_native.h>
#include <Quarisma/ops/permute_native.h>
#include <Quarisma/ops/ravel_native.h>
#include <Quarisma/ops/repeat_native.h>
#include <Quarisma/ops/reshape_as_native.h>
#include <Quarisma/ops/reshape_native.h>
#include <Quarisma/ops/resize_native.h>
#include <Quarisma/ops/row_stack_native.h>
#include <Quarisma/ops/select.h>
#include <Quarisma/ops/select_backward_native.h>
#include <Quarisma/ops/select_copy_native.h>
#include <Quarisma/ops/select_native.h>
#include <Quarisma/ops/select_scatter_native.h>
#include <Quarisma/ops/set_native.h>
#include <Quarisma/ops/slice.h>
#include <Quarisma/ops/slice_backward_native.h>
#include <Quarisma/ops/slice_copy_native.h>
#include <Quarisma/ops/slice_inverse_native.h>
#include <Quarisma/ops/slice_native.h>
#include <Quarisma/ops/slice_scatter_native.h>
#include <Quarisma/ops/sparse_coo_tensor.h>
#include <Quarisma/ops/sparse_coo_tensor_native.h>
#include <Quarisma/ops/sparse_dim_native.h>
#include <Quarisma/ops/split_copy_native.h>
#include <Quarisma/ops/split_native.h>
#include <Quarisma/ops/split_with_sizes.h>
#include <Quarisma/ops/split_with_sizes_copy_native.h>
#include <Quarisma/ops/split_with_sizes_native.h>
#include <Quarisma/ops/squeeze.h>
#include <Quarisma/ops/squeeze_copy_native.h>
#include <Quarisma/ops/squeeze_native.h>
#include <Quarisma/ops/stack_native.h>
#include <Quarisma/ops/sub.h>
#include <Quarisma/ops/sum.h>
#include <Quarisma/ops/sum_to_size_native.h>
#include <Quarisma/ops/swapaxes_native.h>
#include <Quarisma/ops/swapdims_native.h>
#include <Quarisma/ops/t_copy_native.h>
#include <Quarisma/ops/t_native.h>
#include <Quarisma/ops/tensor.h>
#include <Quarisma/ops/tensor_split.h>
#include <Quarisma/ops/tensor_split_native.h>
#include <Quarisma/ops/tile_native.h>
#include <Quarisma/ops/transpose.h>
#include <Quarisma/ops/transpose_copy_native.h>
#include <Quarisma/ops/transpose_native.h>
#include <Quarisma/ops/unbind.h>
#include <Quarisma/ops/unbind_copy_native.h>
#include <Quarisma/ops/unbind_native.h>
#include <Quarisma/ops/unflatten_dense_tensors_native.h>
#include <Quarisma/ops/unflatten_native.h>
#include <Quarisma/ops/unfold_copy_native.h>
#include <Quarisma/ops/unfold_native.h>
#include <Quarisma/ops/unsafe_chunk_native.h>
#include <Quarisma/ops/unsafe_split_native.h>
#include <Quarisma/ops/unsafe_split_with_sizes_native.h>
#include <Quarisma/ops/unsqueeze_copy_native.h>
#include <Quarisma/ops/unsqueeze_native.h>
#include <Quarisma/ops/values_copy_native.h>
#include <Quarisma/ops/view_as_complex.h>
#include <Quarisma/ops/view_as_complex_copy_native.h>
#include <Quarisma/ops/view_as_native.h>
#include <Quarisma/ops/view_as_real.h>
#include <Quarisma/ops/view_as_real_copy_native.h>
#include <Quarisma/ops/view_copy_native.h>
#include <Quarisma/ops/view_native.h>
#include <Quarisma/ops/vsplit_native.h>
#include <Quarisma/ops/vstack.h>
#include <Quarisma/ops/vstack_native.h>
#include <Quarisma/ops/zeros.h>
#include <Quarisma/ops/zeros_like.h>
#include <Quarisma/ops/zeros_native.h>
#endif
...
TORCH_PRECOMPUTE_META_FUNC(cat)(const ITensorListRef& tensors, int64_t dim)
{
    ...
    TORCH_CHECK_VALUE(!materialized.empty(), "torch.cat(): expected a non-empty list of Tensors");
    ...
    TensorOptions options =
        materialized[0].get().options().dtype(out_dtype).memory_format(memory_format);
    ...
    if (found_valid_tensor)
    {
        ...
        options = materialized[valid].get().options().dtype(out_dtype).memory_format(memory_format);
    }
...
{
    int64_t new_size = static_cast<int64_t>(source.nbytes() / result.dtype().itemsize());
...
Tensor& set_storage_cpu_(
    Tensor& result, Storage storage, int64_t storage_offset, IntArrayRef size, IntArrayRef stride)
{
    ...
    c10::SymIntArrayRef stride)
{
    ...
    if (TORCH_GUARD_OR_TRUE(result.sym_numel().sym_ne(0)))
    {
        ...
        if (result.sym_numel().has_hint())
        {
            ...
            c10::SymInt new_size_bytes =
                result.is_contiguous() ? at::detail::computeStorageNbytesContiguous(
...
{
    TORCH_CHECK(
        storage.is_contiguous(), "passed in tensor to be used as storage must be contiguous");
    return result.set__symint(
        storage.storage(), storage_offset + storage.sym_storage_offset(), size, stride);
}
...
{
    caffe2::TypeMeta dtype = result.dtype();
    Storage          storage(Storage::use_byte_size_t(), 0, c10::GetAllocator(kMeta), true);
    result.set_(std::move(storage), 0, {0}, {});
    TORCH_INTERNAL_ASSERT(dtype == result.dtype());
    return result;
}
...
Tensor sparse_broadcast_to(const Tensor& self, IntArrayRef size)
{
    ...
    TORCH_CHECK(
        new_sparse_dims >= 0, "the requested broadcast shape has fewer dimensions than the input");
    ...
    bool is_coalesced =
        !self.dim() ||
        (self.is_coalesced() && (max_unchanged_dim < min_broadcast_dim || min_broadcast_dim == -1));
    ...
    if (largest_sparse_dim_len < 0)
    {
        return at::sparse_coo_tensor(
            self._indices(), broadcast_values, size, self.options(), self.is_coalesced());
    }
 ...
 const Tensor&         result)
{
    ...
    int64_t offset = 0;
    if (all_same_sizes_and_stride && result.is_contiguous(memory_format) && all_same_dtype)
    {
...
static bool sizes_match_except(
    IntArrayRef s1, IntArrayRef s2, int64_t dim_except /* should already be wrapped */)
{
    if (s1.size() != s2.size())
    {
        return false;
...
static Tensor cat_sparse_impl(const MaterializedITensorListRef& tensors, int64_t dim)
{
    ...
    else
    {
        ...
        const int64_t total_size = std::accumulate(
            ...
            [values_dim](int64_t l, const Tensor& r) { return l + r._values().size(values_dim); });
...
Tensor block_diag(TensorList tensors)
{
    ...
    result = at::zeros({result_dim0, result_dim1}, tensors[0].options().dtype(output_scalar_type));
...
std::vector<Tensor> tensor_split_sections_symint(
    const Tensor& self, c10::SymInt sym_sections, int64_t dim)
{
    TORCH_CHECK(
        self.dim() > 0,
    ...
    {
        auto split_size =
            (num_splits_one_extra > split_idx) ? (min_split_size + 1) : min_split_size;
...
static std::vector<Tensor> _tensor_split_indices(
    const Tensor& self, ArrayRef<T> indices, int64_t dim)
{
    TORCH_CHECK(
        self.dim() > 0,
        "tensor_split expected at least a 1-dimensional tensor, but got a tensor with ",
    ...
    splits[num_indices] =
        at::symint::slice<T>(self, dim_, start_idx, at::symint::size<T>(self, dim_));
    return splits;
}
...
std::vector<Tensor> tensor_split_indices_symint(
    const Tensor& self, SymIntArrayRef indices, int64_t dim)
{
    return _tensor_split_indices(self, indices, dim);
}
    ...
    const Tensor& self, const Tensor& tensor_indices_or_sections, int64_t dim)
{
    ...
    TORCH_CHECK(
        ...
        "one-dimensional tensor, but got a tensor with ",
        split_dim,
        " dims");
...
Tensor diagonal(const Tensor& self, Dimname outdim, Dimname dim1, Dimname dim2, int64_t offset)
{
    auto result = at::diagonal(
        self, offset, dimname_to_position(self, dim1), dimname_to_position(self, dim2));
...
Tensor expand(const Tensor& self, c10::IntArrayRef size, bool /*unused*/)
{
    ...
    auto result = self.as_strided(expandedSizesAndStrides.sizes, expandedSizesAndStrides.strides);
...
static Tensor make_qtensor(
    const Tensor& self, IntArrayRef size, IntArrayRef stride, QuantizerPtr quantizer)
{
...
static inline void setStridedUnchecked(
    const Tensor& self, ArrayRef<T> size, ArrayRef<T> stride, T&& storage_offset)
{
    ...
    const Tensor& self, int64_t dim, int64_t start, int64_t length, Tensor& output)
{
    ...
    for (const auto i : c10::irange(num_blocks))
    {
        ...
        memcpy(local_dst_offset_bytes, local_src_offset_bytes, dst_block_size_bytes);
    }
    return output;
}
...
Tensor narrow_symint(const Tensor& self, int64_t dim, SymInt start, SymInt length)
{
    ...
    else
    {
        ...
        auto result        = at::slice_symint(self, dim, start, end + use_different * cur_size, 1);
...
{
    TORCH_CHECK(
        start.dim() == 0 && isIntegralType(start.scalar_type(), /*includeBool=*/false),
        "start must be an 0-dim integral Tensor.");
    int64_t st = start.item<int64_t>();
    return at::narrow_symint(self, dim, c10::SymInt(st), std::move(length));
}

std::tuple<DimVector, DimVector, std::vector<int64_t>> static _permute_size_stride_estimation(
...
Tensor permute_sparse_coo(const Tensor& self, IntArrayRef dims)
{
    ...
    const auto new_indices =
        (new_sparse_dims == old_sparse_dims) ? std::move(old_indices) : [&]() -> Tensor
    {
    ...
    const auto new_values =
        (new_dense_dims == old_dense_dims) ? std::move(old_values) : [&]() -> Tensor
    {
...
Tensor repeat(const Tensor& self, IntArrayRef repeats)
{
    TORCH_CHECK(
        ...
        "Number of dimensions of repeat dims can not be smaller than number of dimensions of "
        "tensor");
...
static Tensor alias_with_sizes_and_strides(const Tensor& self, const Vec& sizes, const Vec& strides)
{
...
static Tensor alias_with_sizes_and_strides(
    const Tensor& self, const Container<c10::SymInt>& sizes, const Container<c10::SymInt>& strides)
{
    // caller should make sure that sizes and strides are valid for self
    //(storage is sufficient, strides are non-negative, strides and sizes array
    // size is the same)
...
static QuantizerPtr create_subtensor_quantizer(
    const Tensor& self, bool is_select, int64_t start, int64_t end, int64_t dim, int64_t step)
{
    ...
    if (dim == axis)
    {
        ...
        zero_points =
            is_select ? zero_points.select(0, start) : zero_points.slice(0, start, end, step);
    }
    if (scales.numel() > 1)
    {
        ...
        quantizer = make_per_channel_affine_quantizer(
            scales, zero_points, (is_select ? axis - 1 : axis), quantizer_prev->scalar_type());
    }
    else
    {
...
Tensor select_symint(const Tensor& self, int64_t dim, c10::SymInt index)
{
    ...
    if (self.is_quantized())
    {
        ...
        auto quantizer =
            create_subtensor_quantizer(self, true, local_index, local_index + 1, dim, 1);
...
Tensor select_backward_symint(
    const Tensor& grad, c10::SymIntArrayRef input_sizes, int64_t dim, c10::SymInt index)
{
    ...
    if (dim < sparse_dim)
    {
        ...
        const auto get_selected_indices_small_nnz_large_size = [&]() -> std::tuple<Tensor, Tensor>
        {
            ...
            const auto n_threads_index = std::max<int64_t>(
                1,
                std::min<int64_t>(
                    (index_len + grain_size - 1) / grain_size, at::get_num_threads()));
                ...
                if (search_in_dim_indices)
                {
                    ...
                    if (self.is_coalesced() && dim == 0)
                    {
                        return std::make_tuple(
                            dim_indices, at::arange(nnz, dim_indices.options()), nneg_index);
                    }
                    else
                    {
            ...
            const auto n_threads_src  = std::max<int64_t>(
                ...
                1,
                std::min<int64_t>(
                    (src_len + src_grain_size - 1) / src_grain_size, at::get_num_threads()));
            ...
            // fill in src_int_idx, sorted_int_idx, int_counts
            {
                ...
                at::parallel_for(
                    ...
                    n_threads_src,
                    1,
                    [&](int64_t tid, [[maybe_unused]] int64_t _)
                    {
            ...
            return search_in_dim_indices ? std::make_tuple(selected_sorted, selected_src)
        ...
        const auto sorted_idx_to_cidx =
            [](const Tensor& idx, int64_t len, bool run_in_parallel = true) -> Tensor
        {
        ...
        const auto get_selected_indices_large_nnz_small_size = [&]() -> std::tuple<Tensor, Tensor>
        {
                                                   ...
                                                   at::internal::GRAIN_SIZE) -> Tensor
            {
                ...
                const auto n_threads = std::max<int64_t>(
                    1,
                    std::min<int64_t>(
                        (idx_len + grain_size - 1) / grain_size, at::get_num_threads()));
            ...
            const auto search_in_dim_indices = [&]() -> bool
            {
                ...
                return index_max_work_per_thread <= dim_indices_max_work_per_thread ? true : false;
            }();
            ...
            {
                return search_in_dim_indices ? std::make_tuple(
                                                   nneg_index,
            ...
            std::tie(src_idx, src_idx_offsets) =
                [&](int64_t grain_size = at::internal::GRAIN_SIZE) -> std::tuple<Tensor, Tensor>
            {
                ...
                const auto n_threads_src = std::max<int64_t>(
                    1,
                    std::min<int64_t>(
                        (src_len + grain_size - 1) / grain_size, at::get_num_threads()));
                    ...
                    [&](int64_t tid, [[maybe_unused]] int64_t _)
                    {
                        ...
                        for (const auto i : c10::irange(start, end))
                        {
                            ...
                            if (!ptr_intersection_counts[idx_val])
                                continue;
                            const auto idx_val_offset = ptr_src_intersection_offsets[idx_val] -
                            ...
                            ptr_src_idx
                                [idx_val_offset + idx_val_tid_offset + idx_val_local_tid_count] = i;
            ...
            return search_in_dim_indices ? std::make_tuple(src_selected, idx_selected)
...
Tensor stack(TensorList tensors, int64_t dim)
{
    ...
    {  // dim = tensors[0].ndimension() cannot be efficiently handled by
        // view
...
static Tensor& propagate_transposed_names(
    Tensor& result, const Tensor& other, int64_t dim0, int64_t dim1)
{
    if (other.has_names())
    {
...
{
    return at::transpose(self, dimname_to_position(self, dim0), dimname_to_position(self, dim1));
}
...
inline Tensor sparse_compressed_transpose(const Tensor& self, int64_t dim0, int64_t dim1)
{
    ...
    enum class TransposeDim : uint8_t
    {
        Batch,
        Sparse,
        Dense
    ...
    const auto transpose_type = classify_dim(dim0);
    {
        ...
        TORCH_CHECK(
            ...
            "transpose(): can only transpose dimensions of the same type (Batch, Sparse, Dense), "
            "got ",
            dim0,
            "(",
    ...
    else if (transpose_type == TransposeDim::Dense)
    {
        ...
        TORCH_INTERNAL_ASSERT(false, "transpose(): Shouldn't have reached this point");
...
Tensor transpose(const Tensor& self, int64_t dim0, int64_t dim1)
{
    ...
    if (self.layout() == kSparseBsr || self.layout() == kSparseCsr || self.layout() == kSparseBsc ||
...
std::tuple<SymDimVector, SymDimVector> static inferSqueezeGeometry(const Tensor& tensor)
{
    SymDimVector sizes;
...
std::tuple<SymDimVector, SymDimVector> static inferSqueezeGeometry(
    const Tensor& tensor, int64_t dim)
{
    SymDimVector sizes;
    SymDimVector strides;
...
std::tuple<SymDimVector, SymDimVector> static inferSqueezeGeometry(
    const Tensor& tensor, std::bitset<dim_bitset_size> dim_mask)
{
...
InferUnsqueezeGeometryResult<int64_t> inferUnsqueezeGeometry(const Tensor& tensor, int64_t dim)
{
...
Tensor squeeze_qtensor(const Tensor& self, c10::OptionalIntArrayRef dims)
{
    auto       quantizer  = get_qtensorimpl(self)->quantizer();
    const auto ndim       = self.dim();
    auto       mask       = dims.has_value() ? dim_list_to_bitset(dims, self.dim())
    ...
    if (quantizer->qscheme() == QScheme::PER_CHANNEL_AFFINE)
    {
        ...
        for (const auto d : c10::irange(ndim))
        {
            if (mask.test(d) && self.sizes()[d] == 1)
            {
                TORCH_CHECK(
                    axis != d,
                    "Squeeze is only possible on non-axis dimension for Per-Channel Quantized "
                    "Tensors.");
                if (d < axis)
                {
                    ++shift;
...
Tensor flatten(const Tensor& self, int64_t start_dim, int64_t end_dim)
{
    ...
    TORCH_CHECK(
        start_dim <= end_dim, "flatten() has invalid args: start_dim cannot come after end_dim");
    ...
    auto slice_numel =
        c10::multiply_integers(self.sym_sizes().slice(start_dim, end_dim - start_dim + 1));
...
Tensor flatten(const Tensor& self, DimnameList dims, Dimname out_dim)
{
    ...
    TORCH_CHECK(!positions.empty(), "flatten(tensor, dims, out_dim): dims cannot be empty");
...
static inline void handle_unflatten_exception(
    const std::exception& e, const Tensor& self, int64_t dim, SymIntArrayRef sizes)
{
...
static Tensor unflatten_impl(
    const Tensor& self, int64_t dim, SymIntArrayRef sizes, std::optional<DimnameList> names)
{
    dim = maybe_wrap_dim(dim, self.dim());
...
Tensor unflatten_dimname_symint(
    const Tensor& self, Dimname dim, SymIntArrayRef sizes, DimnameList names)
{
...
std::vector<Tensor> meshgrid(TensorList tensors, std::string_view indexing)
{
    ...
    std::vector<std::reference_wrapper<const Tensor>> tensor_refs(tensors.begin(), tensors.end());
    ...
    for (const auto i : c10::irange(size))
    {
        TORCH_CHECK(
            ...
            tensor_refs[i]);
        shape[i] =
            tensor_refs[i].get().sym_numel();  // treat 0D tensors as if they were a 1D tensor
    }
...
Tensor numpy_T(const Tensor& self)
{
    ...
    if (n != 2 && n != 0)
    {
        TORCH_WARN_ONCE(
            ...
            "deprecated ",
            "and it will throw an error in a future release. Consider `x.mT` to transpose batches "
            "of matrices ",
            "or `x.permute(*torch.arange(x.ndim - 1, -1, -1))` to reverse the dimensions of a "
            "tensor.");
    }
    if (n == 0)
    {
...
Tensor mT(const Tensor& self)
{
    if (self.dim() == 0)
    {
        // Added in PyTorch 2.0
        TORCH_WARN_ONCE(
            "Tensor.mT is deprecated on 0-D tensors. This function is the identity in these "
            "cases.");
    }
...
Tensor diagonal_backward_symint(
    const Tensor& grad, SymIntArrayRef input_sizes, int64_t offset, int64_t dim1, int64_t dim2)
{
    auto grad_input = at::zeros_symint(input_sizes, grad.options());
...
at::Tensor clone_preserve_strides(const at::Tensor& self)
{
    ...
    auto out =
        clone.as_strided_symint(self.sym_sizes(), self.sym_strides(), self.sym_storage_offset());
    return out;
}
...
at::Tensor select_scatter_symint(
    const at::Tensor& self, const at::Tensor& src, int64_t dim, c10::SymInt index)
{
    auto output = clone_preserve_strides(self);
...
at::Tensor diagonal_scatter(
    const at::Tensor& self, const at::Tensor& src, int64_t offset, int64_t dim1, int64_t dim2)
{
    // See Note [*_scatter ops preserve strides]
    auto output = clone_preserve_strides(self);
...
void split_copy_Tensor_out(
    const at::Tensor& self, int64_t split_size, int64_t dim, at::TensorList out)
{
...
void copy_tensor_array_to_out(
    const char* name, const std::vector<Tensor>& array, at::TensorList out)
{
    TORCH_CHECK(
        out.size() == array.size(),
        name,
...
void split_with_sizes_copy_out(
    const at::Tensor& self, at::IntArrayRef split_sizes, int64_t dim, at::TensorList out)
{
...
void unbind_copy_int_out(const at::Tensor& self, int64_t dim, at::TensorList out)
{
    if (at::GradMode::is_enabled())
    {
        for (const auto i : c10::irange(out.size()))
        {
            TORCH_CHECK(
                !out[i].requires_grad(),
                "unbind_copy(): functions with out=... arguments don't support automatic "
                "differentiation, "
