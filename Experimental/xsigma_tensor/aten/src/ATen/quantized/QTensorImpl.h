...
public:
    ...
    QuantizerPtr quantizer() { return quantizer_; }

    void set_quantizer_(QuantizerPtr quantizer) { quantizer_ = quantizer; }
   ...
   */
    ...
    {
        auto impl =
            c10::make_intrusive<QTensorImpl>(Storage(storage()), key_set(), data_type_, quantizer_);
