...
#include <Quarisma/selected_mobile_ops.h>
#else
namespace at
{
/**
...
#define RECORD_KERNEL_FUNCTION_DTYPE(NAME, enum_type) \
    at::detail::record_kernel_function_dtype(std::string(NAME) + "$" + toString(enum_type));
#else
#define RECORD_KERNEL_FUNCTION_DTYPE(NAME, enum_type)
#endif
...
#define AT_PRIVATE_CHECK_SELECTIVE_BUILD(enum_type)                                  \
    do                                                                               \
    {                                                                                \
        if constexpr (!at::should_include_kernel_dtype(at_dispatch_name, enum_type)) \
        {                                                                            \
            TORCH_CHECK(                                                             \
                false,                                                               \
                "dtype '",                                                           \
...
#define AT_QINT_SUB_BYTE_PRIVATE_CASE_TYPE(enum_type, scalar_type, bitwidth, qmin, qmax, ...) \
    case enum_type:                                                                           \
    {                                                                                         \
        AT_PRIVATE_CHECK_SELECTIVE_BUILD(enum_type);                                          \
        using scalar_t                               = scalar_type;                           \
    ...
    {                                                                                          \
        ...
        default:                                                                               \
            TORCH_CHECK_NOT_IMPLEMENTED(                                                       \
                false, '"', at_dispatch_name, "\" not implemented for '", toString(_st), "'"); \
        }                                                                                      \
    }()
...
#define AT_DISPATCH_FLOATING_TYPES_AND(SCALARTYPE, TYPE, NAME, ...) \
    AT_DISPATCH_SWITCH(TYPE, NAME, AT_DISPATCH_CASE_FLOATING_TYPES_AND(SCALARTYPE, __VA_ARGS__))
...
#define AT_DISPATCH_FLOATING_TYPES_AND2(SCALARTYPE1, SCALARTYPE2, TYPE, NAME, ...) \
    AT_DISPATCH_SWITCH(                                                            \
        TYPE, NAME, AT_DISPATCH_CASE_FLOATING_TYPES_AND2(SCALARTYPE1, SCALARTYPE2, __VA_ARGS__))
...
#define AT_DISPATCH_FLOATING_TYPES_AND3(SCALARTYPE1, SCALARTYPE2, SCALARTYPE3, TYPE, NAME, ...) \
    AT_DISPATCH_SWITCH(                                                                         \
        TYPE,                                                                                   \
        NAME,                                                                                   \
        AT_DISPATCH_CASE_FLOATING_TYPES_AND3(SCALARTYPE1, SCALARTYPE2, SCALARTYPE3, __VA_ARGS__))
...
#define AT_DISPATCH_COMPLEX_TYPES_AND(SCALARTYPE, TYPE, NAME, ...) \
    AT_DISPATCH_SWITCH(TYPE, NAME, AT_DISPATCH_CASE_COMPLEX_TYPES_AND(SCALARTYPE, __VA_ARGS__))
...
#define AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES(TYPE, NAME, ...) \
    AT_DISPATCH_SWITCH(TYPE, NAME, AT_DISPATCH_CASE_FLOATING_AND_COMPLEX_TYPES(__VA_ARGS__))
...
#define AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND1(SCALARTYPE, TYPE, NAME, ...) \
    AT_DISPATCH_SWITCH(                                                          \
        TYPE, NAME, AT_DISPATCH_CASE_FLOATING_AND_COMPLEX_TYPES_AND1(SCALARTYPE, __VA_ARGS__))

#define AT_DISPATCH_CASE_FLOATING_AND_COMPLEX_TYPES_AND2(SCALARTYPE1, SCALARTYPE2, ...) \
    AT_DISPATCH_CASE_FLOATING_AND_COMPLEX_TYPES(__VA_ARGS__)                            \
    AT_DISPATCH_CASE(SCALARTYPE1, __VA_ARGS__)                                          \
    AT_DISPATCH_CASE(SCALARTYPE2, __VA_ARGS__)
...
#define AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND2(SCALARTYPE1, SCALARTYPE2, TYPE, NAME, ...) \
    AT_DISPATCH_SWITCH(                                                                        \
        TYPE,                                                                                  \
        NAME,                                                                                  \
        AT_DISPATCH_CASE_FLOATING_AND_COMPLEX_TYPES_AND2(SCALARTYPE1, SCALARTYPE2, __VA_ARGS__))
...
#define AT_DISPATCH_INTEGRAL_TYPES_AND(SCALARTYPE, TYPE, NAME, ...) \
    AT_DISPATCH_SWITCH(TYPE, NAME, AT_DISPATCH_CASE_INTEGRAL_TYPES_AND(SCALARTYPE, __VA_ARGS__))
...
#define AT_DISPATCH_QINT_TYPES_AND(SCALARTYPE, TYPE, NAME, ...) \
    AT_DISPATCH_SWITCH(TYPE, NAME, AT_DISPATCH_CASE_QINT_TYPES_AND(SCALARTYPE, __VA_ARGS__))
...
#define AT_DISPATCH_CASE_QINT_AND_SUB_BYTE_TYPES(...)                                      \
    ...
    AT_QINT_SUB_BYTE_PRIVATE_CASE_TYPE(                                                    \
        at::kQInt32, at::qint32, CHAR_BIT * sizeof(int), INT_MIN, INT_MAX, __VA_ARGS__)    \
    AT_QINT_SUB_BYTE_PRIVATE_CASE_TYPE(at::kQUInt4x2, at::quint4x2, 4, 0, 15, __VA_ARGS__) \
    AT_QINT_SUB_BYTE_PRIVATE_CASE_TYPE(at::kQUInt2x4, at::quint2x4, 2, 0, 3, __VA_ARGS__)

#define AT_DISPATCH_QINT_AND_SUB_BYTE_TYPES(TYPE, NAME, ...) \
    AT_DISPATCH_SWITCH(TYPE, NAME, AT_DISPATCH_CASE_QINT_AND_SUB_BYTE_TYPES(__VA_ARGS__))
...
#define AT_DISPATCH_ALL_TYPES_AND_COMPLEX(TYPE, NAME, ...) \
    AT_DISPATCH_SWITCH(TYPE, NAME, AT_DISPATCH_CASE_ALL_TYPES_AND_COMPLEX(__VA_ARGS__))
...
#define AT_DISPATCH_ALL_TYPES_AND(SCALARTYPE, TYPE, NAME, ...) \
    AT_DISPATCH_SWITCH(TYPE, NAME, AT_DISPATCH_CASE_ALL_TYPES_AND(SCALARTYPE, __VA_ARGS__))
...
#define AT_DISPATCH_ALL_TYPES_AND_COMPLEX_AND(SCALARTYPE, TYPE, NAME, ...) \
    AT_DISPATCH_SWITCH(                                                    \
        TYPE, NAME, AT_DISPATCH_CASE_ALL_TYPES_AND_COMPLEX_AND(SCALARTYPE, __VA_ARGS__))
...
#define AT_DISPATCH_ALL_TYPES_AND2(SCALARTYPE1, SCALARTYPE2, TYPE, NAME, ...) \
    AT_DISPATCH_SWITCH(                                                       \
        TYPE, NAME, AT_DISPATCH_CASE_ALL_TYPES_AND2(SCALARTYPE1, SCALARTYPE2, __VA_ARGS__))

#define AT_DISPATCH_CASE_ALL_TYPES_AND_COMPLEX_AND2(SCALARTYPE1, SCALARTYPE2, ...) \
    AT_DISPATCH_CASE_ALL_TYPES_AND_COMPLEX(__VA_ARGS__)                            \
    AT_DISPATCH_CASE(SCALARTYPE1, __VA_ARGS__)                                     \
    AT_DISPATCH_CASE(SCALARTYPE2, __VA_ARGS__)
...
#define AT_DISPATCH_ALL_TYPES_AND_COMPLEX_AND2(SCALARTYPE1, SCALARTYPE2, TYPE, NAME, ...) \
    AT_DISPATCH_SWITCH(                                                                   \
        TYPE,                                                                             \
        NAME,                                                                             \
        AT_DISPATCH_CASE_ALL_TYPES_AND_COMPLEX_AND2(SCALARTYPE1, SCALARTYPE2, __VA_ARGS__))

#define AT_DISPATCH_CASE_ALL_TYPES_AND3(SCALARTYPE1, SCALARTYPE2, SCALARTYPE3, ...) \
    AT_DISPATCH_CASE_ALL_TYPES(__VA_ARGS__)                                         \
    AT_DISPATCH_CASE(SCALARTYPE1, __VA_ARGS__)                                      \
    AT_DISPATCH_CASE(SCALARTYPE2, __VA_ARGS__)                                      \
    AT_DISPATCH_CASE(SCALARTYPE3, __VA_ARGS__)
...
#define AT_DISPATCH_ALL_TYPES_AND3(SCALARTYPE1, SCALARTYPE2, SCALARTYPE3, TYPE, NAME, ...) \
    AT_DISPATCH_SWITCH(                                                                    \
        TYPE,                                                                              \
        NAME,                                                                              \
        AT_DISPATCH_CASE_ALL_TYPES_AND3(SCALARTYPE1, SCALARTYPE2, SCALARTYPE3, __VA_ARGS__))

#define AT_DISPATCH_CASE_ALL_TYPES_AND_COMPLEX_AND3(SCALARTYPE1, SCALARTYPE2, SCALARTYPE3, ...) \
    AT_DISPATCH_CASE_ALL_TYPES_AND_COMPLEX(__VA_ARGS__)                                         \
    AT_DISPATCH_CASE(SCALARTYPE1, __VA_ARGS__)                                                  \
    AT_DISPATCH_CASE(SCALARTYPE2, __VA_ARGS__)                                                  \
    AT_DISPATCH_CASE(SCALARTYPE3, __VA_ARGS__)
