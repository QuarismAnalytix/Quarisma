...
struct TORCH_API TensorGeometry
{
    ...
    explicit TensorGeometry(c10::SymIntArrayRef sizes)
        : sizes_(sizes.vec()),
          strides_(sizes.size()),
          has_symbolic_sizes_strides_(!c10::asIntArrayRefSlowOpt(sizes).has_value())
    {
    ...
    explicit TensorGeometry(
        std::vector<at::SymInt> sizes, std::vector<at::SymInt> strides, at::SymInt storage_offset)
    ...
    c10::SymIntArrayRef sym_sizes() const { return sizes_; }
    c10::SymInt         sym_stride(int64_t dim) const
    {
        dim = c10::maybe_wrap_dim(dim, this->dim());
        return strides_.at(static_cast<size_t>(dim));
    }
    c10::SymIntArrayRef sym_strides() const { return strides_; }
    c10::SymInt         sym_storage_offset() const { return storage_offset_; }
    c10::SymInt         sym_numel() const { return numel_; }
    ...
    std::vector<c10::SymInt>& mutable_sizes() { return sizes_; }
    std::vector<c10::SymInt>& mutable_strides() { return strides_; }
    c10::SymInt&              mutable_storage_offset() { return storage_offset_; }
    void                      recompute()
    {
        ...
        has_symbolic_sizes_strides_ = !c10::asIntArrayRefSlowOpt(sizes_).has_value();
    }
