/** \brief Fusing linear patterns as single quarisma::linear for easier pattern
...
/** \brief Match the quarisma::linear pattern and fuse it into a single quarisma::linear
