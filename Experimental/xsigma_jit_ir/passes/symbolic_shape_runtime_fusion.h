...
// the inputs quarisma runtime match the Generalized Symbolic Shapes that are inputs
...
// examples and walkthrough look quarisma ShapeAnalysisTest.DynamicShapesFusion in
