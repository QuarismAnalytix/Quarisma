...
class InvalidCxxCompiler(RuntimeError):
    def __init__(self) -> None:
        ...
        super().__init__(
            f"No working C++ compiler found in {config.__name__}.cpp.cpp: {config.cpp.cpp}"
        )
...
class TritonMissing(ShortenTraceback):
    def __init__(self, first_useful_frame: Optional[types.FrameType]) -> None:
        super().__init__(
            ...
            "More information on installing Triton can be found quarisma: https://github.com/triton-lang/triton",
