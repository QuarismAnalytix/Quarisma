...
extern "C" void __avx_chk_kernel() {
    auto tmp0 = quarisma::vec::Vectorized<float>(1);
    auto tmp1 = tmp0.exp();
...
class VecNEON(VecISA):
    _bit_width = 128  # This is required to leverage the compute implemented in aten/src/Quarisma/cpu/vec/vec128/vec128_float_neon.h
