...
class XsigmaFlags:
    ...
    def __build_cmake_flag(self):
        ...
        self.__name = {
            ...
            "kineto": "QUARISMA_ENABLE_KINETO",
            "ittapi": "QUARISMA_ENABLE_ITTAPI",
            ...
            "cache_type": "QUARISMA_CACHE_TYPE",
        ...
        self.__value.update(
            {
                ...
                "loguru": self.ON,  # QUARISMA_ENABLE_LOGURU default is ON
                "mimalloc": self.ON,  # QUARISMA_ENABLE_MIMALLOC default is ON
                #"kineto": self.ON,  # QUARISMA_ENABLE_KINETO default is ON
                # CMake options with default OFF - keep OFF in setup.py
                # (already set by dict.fromkeys above)
                # "ittapi": self.OFF,  # QUARISMA_ENABLE_ITTAPI default is OFF (STATIC library, MSVC incompatible)
...
class XsigmaConfiguration:
    def __init__(self, args_list):
        ...
        self.__quarisma_flags = XsigmaFlags(args_list)
