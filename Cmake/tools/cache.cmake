...
set(QUARISMA_CACHE_TYPE "none"
    CACHE STRING "Compiler cache type to use. Options: none, ccache, sccache, buildcache"
)
set_property(CACHE QUARISMA_CACHE_TYPE PROPERTY STRINGS none ccache sccache buildcache)
mark_as_advanced(QUARISMA_CACHE_TYPE)

# Validate cache type
if(NOT QUARISMA_CACHE_TYPE MATCHES "^(none|ccache|sccache|buildcache)$")
  message(
    FATAL_ERROR
      "Invalid QUARISMA_CACHE_TYPE: ${QUARISMA_CACHE_TYPE}. Valid options are: none, ccache, sccache, buildcache"
  )
endif()
...
message(STATUS "Configuring build speed optimizations with cache type: ${QUARISMA_CACHE_TYPE}")
...
if(QUARISMA_CACHE_TYPE STREQUAL "ccache")
...
elseif(QUARISMA_CACHE_TYPE STREQUAL "sccache")
...
elseif(QUARISMA_CACHE_TYPE STREQUAL "buildcache")
...
elseif(QUARISMA_CACHE_TYPE STREQUAL "none")
