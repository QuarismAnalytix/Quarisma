...
function(print_configuration_summary)
  ...
  message("  Compiler cache        : ${XSIGMA_CACHE_BACKEND}")
  ...
  if(XSIGMA_ENABLE_TBB)
    set(_xsigma_parallel_backend "TBB")
  elseif(XSIGMA_ENABLE_OPENMP)
    set(_xsigma_parallel_backend "OpenMP")
  else()
    set(_xsigma_parallel_backend "STDThread")
  endif()
  message("    USE_GOLD_LINKER     : ${XSIGMA_ENABLE_GOLD_LINKER}")
  message("    Multithreading      : ${_xsigma_parallel_backend}")
  message("    Logging backend     : ${XSIGMA_LOGGING_BACKEND}")
  message("    Profiling backend   : ${XSIGMA_PROFILER_TYPE}")
  message("    Cache backend       : ${XSIGMA_CACHE_BACKEND}")
