...
function(print_configuration_summary)
  ...
  message("  Compiler cache        : ${QUARISMA_CACHE_TYPE}")
  ...
  if(QUARISMA_ENABLE_TBB)
    set(_quarisma_smp_backend "TBB")
  else()
    set(_quarisma_smp_backend "STDThread")
  endif()
  message("    USE_GOLD_LINKER     : ${QUARISMA_ENABLE_GOLD_LINKER}")
  message("    Multithreading      : ${_quarisma_smp_backend}")
  ...
  message("    Loguru              : ${QUARISMA_ENABLE_LOGURU}")
