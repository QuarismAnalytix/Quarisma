 ...
 * `quarismaMultiThreader::GetGlobalDefaultNumberOfThreads()`.
 *
...
#ifndef quarismaThreadedTaskQueue_h
#define quarismaThreadedTaskQueue_h
...
private:
    ...
    std::unique_ptr<quarismaThreadedTaskQueueInternals::TaskQueue<R>>   Tasks;
    std::unique_ptr<quarismaThreadedTaskQueueInternals::ResultQueue<R>> Results;
...
private:
    ...
    std::unique_ptr<quarismaThreadedTaskQueueInternals::TaskQueue<void>> Tasks;
...
#endif
// QUARISMA-HeaderTest-Exclude: threaded_task_queue.h
