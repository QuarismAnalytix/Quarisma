...
#include <xsigma/csrc/distributed/c10d/ParamCommsUtils.hpp>
...
//******************************************************************************
// JSON output utility functions. To be merged with XSigma profiler.
//******************************************************************************
template <typename T>
...
// safe containers.
struct XSIGMA_VISIBILITY ExecutionTraceObserver
{  // NOLINT
    using ID = size_t;
