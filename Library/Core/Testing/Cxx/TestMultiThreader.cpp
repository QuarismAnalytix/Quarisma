...
XSIGMATEST(MultiThreader, creation_and_destruction)
{
...
XSIGMATEST(MultiThreader, default_number_of_threads)
{
...
XSIGMATEST(MultiThreader, maximum_number_of_threads)
{
...
XSIGMATEST(MultiThreader, set_get_number_of_threads)
{
    multi_threader* mt = multi_threader::create();
...
XSIGMATEST(MultiThreader, number_of_threads_clamping)
{
    multi_threader* mt = multi_threader::create();
...
XSIGMATEST(MultiThreader, single_method_execution)
{
    multi_threader* mt = multi_threader::create();
    mt->set_number_of_threads(4);
...
XSIGMATEST(MultiThreader, thread_info_validation)
{
    multi_threader* mt = multi_threader::create();
    mt->set_number_of_threads(4);
...
XSIGMATEST(MultiThreader, single_thread)
{
    multi_threader* mt = multi_threader::create();
...
XSIGMATEST(MultiThreader, multiple_method_execution)
{
    multi_threader* mt = multi_threader::create();
    mt->set_number_of_threads(4);
...
XSIGMATEST(MultiThreader, spawn_and_terminate)
{
    multi_threader* mt = multi_threader::create();
...
XSIGMATEST(MultiThreader, multiple_spawned_threads)
{
    multi_threader* mt = multi_threader::create();
...
XSIGMATEST(MultiThreader, current_thread_id)
{
...
XSIGMATEST(MultiThreader, different_thread_ids)
{
...
XSIGMATEST(MultiThreader, global_maximum)
{
...
XSIGMATEST(MultiThreader, global_default)
{
...
XSIGMATEST(MultiThreader, stress_single_method)
{
    multi_threader* mt = multi_threader::create();
    mt->set_number_of_threads(4);
...
XSIGMATEST(MultiThreader, rapid_thread_changes)
{
    multi_threader* mt = multi_threader::create();
...
XSIGMATEST(MultiThreader, max_threads_execution)
{
    multi_threader* mt = multi_threader::create();
