...
XSIGMATEST(NestedParallelism, basic_nested_parallel_for)
{
...
XSIGMATEST(NestedParallelism, in_parallel_region_check)
{
...
XSIGMATEST(NestedParallelism, thread_naming_in_nested_loops)
{
...
XSIGMATEST(NestedParallelism, parallel_guard_control)
{
...
XSIGMATEST(NestedParallelism, nested_guards_restore_state)
{
    EXPECT_FALSE(parallel_guard::is_enabled());
...
XSIGMATEST(NestedParallelism, nested_parallel_reduce_matrix_sum)
{
...
XSIGMATEST(NestedParallelism, nested_parallel_reduce_matrix_max)
{
...
XSIGMATEST(NestedParallelism, mixed_parallel_for_with_inner_reduce)
{
    constexpr int rows = 10;
    constexpr int cols = 10;
...
XSIGMATEST(NestedParallelism, empty_ranges_nested)
{
...
XSIGMATEST(NestedParallelism, single_element_ranges_nested)
{
...
XSIGMATEST(NestedParallelism, single_element_nested_reduce)
{
...
XSIGMATEST(NestedParallelism, large_nested_iteration)
{
