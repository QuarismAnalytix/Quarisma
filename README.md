...
**Quarisma** is a modern, high-performance quantitative analysis library designed for both CPU and GPU computing. Built with a production-ready C++ foundation and a modern CMake build system, Quarisma provides cross-platform compatibility, advanced optimization capabilities, and flexible dependency management for demanding computational workloads.
...
git clone https://github.com/QuarismAnalytix/Quarisma.git
cd Quarisma
...
1. **Search existing issues** - Check [GitHub Issues](https://github.com/QuarismAnalytix/Quarisma/issues) to see if the bug has already been reported
2. **Create a new issue** - If not found, [open a new issue](https://github.com/QuarismAnalytix/Quarisma/issues/new) with:
...
1. **Search existing discussions** - Check [GitHub Discussions](https://github.com/QuarismAnalytix/Quarisma/discussions) and [Issues](https://github.com/QuarismAnalytix/Quarisma/issues) for similar requests
2. **Create a discussion or issue** - [Start a discussion](https://github.com/QuarismAnalytix/Quarisma/discussions/new) or [open an issue](https://github.com/QuarismAnalytix/Quarisma/issues/new) with:
...
1. **Use GitHub Security Advisories** - Report privately at https://github.com/QuarismAnalytix/Quarisma/security/advisories/new
...
- **Bug Reports & Feature Requests**: [GitHub Issues](https://github.com/QuarismAnalytix/Quarisma/issues)
- **Questions & Discussions**: [GitHub Discussions](https://github.com/QuarismAnalytix/Quarisma/discussions)
- **Security Issues**: [GitHub Security Advisories](https://github.com/QuarismAnalytix/Quarisma/security/advisories) or [security@quarisma.co.uk](mailto:security@quarisma.co.uk)
...
- **Dual Licensing** - By contributing, you grant QuarismAnalytix rights to offer commercial licenses
...
Quarisma is dual-licensed under GPL-3.0-or-later and a commercial license. Contact QuarismAnalytix for commercial licensing options.
...
- Repository: [Quarisma](https://github.com/QuarismAnalytix/Quarisma)

---

**Quarisma** - High-performance C++ quantitative analysis library with modern CMake build system
